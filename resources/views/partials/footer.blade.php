    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row items-center justify-between gap-4 text-xs">
            ...
            <div class="flex items-center gap-4 text-slate-500">
                <div class="flex items-center gap-2 px-2.5 py-1 rounded-full bg-slate-50 border border-slate-200/80 font-medium">
                    <span class="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
                    <span class="text-[11px] text-slate-600">All Systems Operational</span>
                </div>
            ...
            <div class="flex items-center gap-4 text-slate-500 font-medium">
                ...
                <a href="#" class="hover:text-brand transition">IT Support</a>
            </div>
