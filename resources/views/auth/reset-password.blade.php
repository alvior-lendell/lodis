        ...
        <div class="order-1 lg:order-2 lg:w-1/2 flex items-center justify-center p-6 sm:p-10 lg:p-16 bg-white relative">
            <div id="auth-container" class="w-full max-w-md transition-all duration-200">
                ...
                <div class="mb-8 text-center lg:text-left">
                    <h3 class="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">Set New Password</h3>
                    <p class="text-xs sm:text-sm text-slate-500 mt-1">
                        Enter your account email and specify a new secure password adhering to corporate security policies.
                    </p>
                </div>
                ...
                <form id="reset-password-form" method="POST" action="{{ route('password.store') }}" autocomplete="off" class="space-y-5 transition-opacity duration-200">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="relative rounded-2xl shadow-sm">
                            ...
                            <input id="email" type="email" name="email" value="{{ old('email', $request->email) }}" required autofocus readonly autocomplete="off"
                                class="form-input block w-full pl-11 pr-4 py-3.5 rounded-2xl border-slate-200 bg-slate-50/80 text-slate-600 text-sm outline-none transition font-medium cursor-not-allowed">
                        </div>
                    </div>
                    ...
                    <!-- Dynamic Password Policy Checklist with Universal Data Attributes -->
            ...
            <div class="relative z-10">
                ...
                <div class="max-w-md my-auto">
                    ...
                    <p class="text-slate-600 text-xs sm:text-sm leading-relaxed mb-8">
                        Updating your password revokes previous active session tokens across internal services to ensure account isolation.
                    </p>

                    <div class="p-4 rounded-2xl bg-white/90 backdrop-blur-md border border-white shadow-md space-y-2">
                        <h4 class="text-xs font-bold text-slate-900 uppercase tracking-wider">Security Tip</h4>
                        <p class="text-xs text-slate-500 leading-relaxed">
                            Avoid using passphrases containing personal names, dictionary words, or dates previously used on company devices.
                        </p>
                    </div>
                </div>
            </div>
